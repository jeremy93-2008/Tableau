...
export function Header() {
    return (
        <div className="h-[68px] flex shadow-sm shadow-teal-600 justify-between items-center px-4 z-10">
            <div className="flex items-center">
                <Icon />
                <div className="ml-2 text-[#2C7A7B] text-xl font-bold">
                    Tableau
                </div>
            </div>
            <div className="flex items-center">
                ...
                <a
                    aria-disabled
                    className="mr-3 text-[#38B2AC] font-semibold cursor-not-allowed border-b-2 border-transparent"
                >
                    Tableau Plus
                </a>
                <a
