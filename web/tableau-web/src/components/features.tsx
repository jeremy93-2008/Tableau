...
export function Features() {
    return (
        <div
            id="features"
            className="flex flex-wrap justify-center items-center px-3 py-8 gap-6
            lg:gap-0 lg:py-0 lg:h-[432px] bg-gradient-to-t from-[#E6F5F5] to-white dark:from-teal-900 dark:to-teal-800"
        >
