// icon:fund-projection-screen | Ant Design Icons https://ant.design/components/icon/ | Ant Design
import * as React from 'react'

function IconFundProjectionScreen(props: any) {
    return (
        <svg
...
export default IconFundProjectionScreen
